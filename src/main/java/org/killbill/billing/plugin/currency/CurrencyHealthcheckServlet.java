...
@Singleton
@Path("/healthcheck")
public class CurrencyHealthcheckServlet extends PluginHealthcheck {

    private final CurrencyHealthcheck healthcheck;

    @Inject
    public CurrencyHealthcheckServlet(final CurrencyHealthcheck healthcheck) {
